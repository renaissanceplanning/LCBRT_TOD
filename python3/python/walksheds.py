...
def generate_walksheds(stations, walk_net, imp_field, cost, out_gdb, stations_wc=None):
    ...
    arcpy.FeatureClassToFeatureClass_conversion(
        in_features="service_area\\polygons", out_path=out_gdb, out_name="walksheds"
    )
...
if __name__ == "__main__":
    ...
    generate_walksheds(stations, walk_net, imp_field, cost, out_gdb, stations_wc)
