...
controls = pd.DataFrame(
    {"Segment": [1, 2, 3], "Res": [5, 7, 1], "Com": [10, 12, 9], "Ind": [3, 2, 8]}
).set_index("Segment")

recips = pd.DataFrame(
    {
        "ParclID": [1000, 10001, 1002, 1003, 2000, 20001, 3000, 30001, 3002],
        "Seg": [1, 1, 1, 1, 2, 2, 3, 3, 3],
        "Suit": [0.01, 0.5, 0.9, 0.7, 1.0, 0.2, 0.8, 0.2, 0.6],
        "ResCap": [10, 0, 4, 2, 0, 20, 0, 0, 0],
        "ComCap": [5, 10, 0, 0, 10, 4, 8, 0, 0],
        "IndCap": [4, 0, 0, 0, 1, 1, 3, 4, 4],
    }
).set_index("ParclID")
